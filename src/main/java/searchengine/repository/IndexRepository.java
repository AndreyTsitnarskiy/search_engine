...
public interface IndexRepository extends JpaRepository<IndexEntity, Integer> {
    ...
    @Query(value = "SELECT page_id FROM sites_parsing.indexes_table WHERE lemma_id IN " +
    ...
    @Query(value = "SELECT * FROM sites_parsing.indexes_table WHERE lemma_id = :lemmaIds" +
